      ...
      <Container>
        <Wrapper>
          <First>
            <NavLink to="/">
              <LogoHold>
                <Logo alt="image" src={img1} />
              </LogoHold>
            </NavLink>
            <SignUpHold>
              <h1>Start Quiz!!</h1>
              <div>
                By Clicking the <strong>Start Quiz Button,</strong> we believe
                you have listen to the instructors and you are to some extent
                Perfectly clear with it.
                <br />
                <br />
                <h2>All the Best!!!</h2>
              </div>
            ...
            <NavLink to={numb !== "" ? "/quiz" : "#"}>
              <Button
                style={{
                  ...
                  cursor: numb !== "" ? "pointer" : "not-allowed",
                }}
              >
                Start Test
              </Button>
